...
public class Annonce {
	...
	public Annonce(int id, String title, String description, String startDate, String endDate,
				   int postsNum, String secteur, String fonction, String experience, String etudeLevel, String contratDetails,
	...
	public void setContracDetails(String contratDetails) {
		this.contratDetails = contratDetails;
	}
	...
	public String toString() {
		return "Annonce [id=" + id + ", title=" + title +", description=" + description
				...
				+ ", contratDetails=" + contratDetails + ", url=" + url + ", siteName=" + siteName
				+ ", adresseEntreprise=" + adresseEntreprise + ", siteWebEntreprise=" + siteWebEntreprise
				+ ", nomEntreprise=" + nomEntreprise + ", descriptionEntreprise=" + descriptionEntreprise
				+ ", region=" + region + ", city=" + city + ", industry=" + industry + ", traitsPersonnalite="
				+ traitsPersonnalite + ", competencesRequises=" + competencesRequises + ", softSkills=" + softSkills
				+ ", competencesRecommandees=" + competencesRecommandees + ", langue=" + langue + ", niveauLangue="
				+ niveauLangue + ", salaire=" + salaire + ", avantagesSociaux=" + avantagesSociaux + ", teletravail="
				+ teletravail + "]";
	}
