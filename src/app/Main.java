...
public class Main {
	public static void main(String[] args) throws SQLException {
        ...
        List<Annonce> listesAnnonces = sitemanager.Insert_mjob_annonces();
        ...
        ActionListener filterListener = e -> {
            ...
            for (Annonce job : listesAnnonces) {
                boolean matchesLocation = selectedLocation.equals("All") || job.getCity().contains(selectedLocation);
                ...
                if (matchesLocation && matchesSecteur&&matchesEtude&&matchesExperience) {
                    ...
                    jobListModel.addElement("Location : "+job.getCity());
                    ...
                    jobListModel.addElement("Details du contrat : "+job.getContratDetails());
